...
def copy_cell(source_cell, target_cell):
    ...
    if source_cell.has_style:
        ...
        # Garante que o formato de número seja sempre uma string válida
    ...
    try:
        ...
        for categoria_nome, categoria_data in itens_agrupados_por_categoria.items():
            ...
            for col_idx in range(1, 8):
                ...
                copy_style(sheet.cell(row=current_row + 1, column=col_idx), sheet.cell(row=current_row, column=col_idx))
        ...
        for merged_range in clauses_sheet.merged_cells:
            new_min_row = merged_range.min_row + row_offset
            new_max_row = merged_range.max_row + row_offset
            sheet.merge_cells(min_row=new_min_row, min_col=merged_range.min_col, max_row=new_max_row, max_col=merged_range.max_col)
        ...
        import traceback
        print("--- DETECTED ERROR IN EXCEL EXPORT ---")
        traceback.print_exc()
        print("-----------------------------------------")
